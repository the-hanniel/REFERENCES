...
/*
        <style type="text/css">
			...
			#close{ color:red; background-color:#fff; }
            .ds_subhead {
...
/*
    ...
    <script type="text/javascript">*/
        ...
        //var ds_daynames = [ 'Mon', 'Tue', 'Wed', 'Thu', 'Fri' ]; // You can translate it for your language.
        ...
        function ds_template_main_above(t) {
            return '<table cellpadding="3" cellspacing="1" class="ds_tbl">'
                ...
                + '<td class="ds_head" id=close style="cursor: pointer" onclick="ds_hi();" colspan="3">Close</td>'
...
<input type="text" name="dat1"onClick="ds_sh(this);" readonly="readonly" style="cursor: text"
